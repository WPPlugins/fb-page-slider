...
/*
Plugin Name: FB Page Slider
Plugin URI: https://wordpress.org/plugins/fb-page-slider/
Description: The Facebook Page Slider is a great addition to your website to display Facebook Feeds on your website. It allows visitors to your page access your Facebook news feed, photos, videos, posts and more, all without ever leaving your website. The Facebook Page Slider is available on the Wordpress platform and works with all versions.
Version: 1.1
Author: twidgets
...
class RealFacebookPageSlider{
    ...
    public static function add_real_fb_page_slider_tools_options_page(){
        ...
        add_options_page('FB Page Slider', 'FB Page Slider ', 'administrator', __FILE__, array('RealFacebookPageSlider','real_fb_page_slider_tools_options'));
